...
The [`examples/`](ansible_collections/seckatie/agents/examples/) directory contains complete playbooks:
...
| [`conversation_continuity.yml`](ansible_collections/seckatie/agents/examples/conversation_continuity.yml) | Two-task conversation passing `message_history` |

## Security

See [SECURITY.md](ansible_collections/seckatie/agents/SECURITY.md) for the full threat model, controls, and recommendations.
